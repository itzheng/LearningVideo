...
JNIEXPORT jint JNICALL
Java_com_cxp_learningvideo_FFEncodeActivity_initEncoder(JNIEnv *env, jobject thiz, jstring inPath,
                                                        jstring outPath) {
...
JNIEXPORT void JNICALL
Java_com_cxp_learningvideo_FFEncodeActivity_startEncoder(JNIEnv *env, jobject thiz,
                                                         jint synthesizer) {
